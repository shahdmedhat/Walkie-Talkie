...
export const nameAlice = "Amira";
// export const uriAlice = "sip:alice." + token + "@" + domain;
export const uriAlice = "sip:amira@amiraa.onsip.com";

export const webSocketServerAlice = "wss://edge.sip.onsip.com";

export const nameBob = "Shahd";
// export const uriBob = "sip:bob." + token + "@" + domain;
export const uriBob = "shahdk@shahdkouraa.onsip.com";
